...
package org.wso2.apim.policies.mediation.ai.semantic.tool.filtering.internal;
...
/**
 * OSGi Declarative Services component for binding the {@link EmbeddingProviderService}.
 * <p>
 * This component registers itself with the OSGi framework and dynamically binds/unbinds
 * the embedding provider service, storing it in the {@link ServiceReferenceHolder} singleton.
 */
@Component(
        name = "org.wso2.apim.policies.mediation.ai.semantic.tool.filtering.internal.EmbeddingProviderComponent",
        immediate = true
)
